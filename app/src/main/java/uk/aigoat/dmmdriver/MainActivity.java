...
public class MainActivity extends Activity {
    ...
    private void installOfflineAndFastSync(WebView view){
        String js="(function(){try{"+
            "if(window.__DMM329)return;window.__DMM329=true;if(!window.DMMNative)return;"+
            "var KEY='dmmJobsV3',MIGRATION='native-jobs-seed-v329';"+
            ...
            "window.__DMM329_SYNC_BRIDGE=true;"+
        ...
        "}catch(e){console.error('DMM v3.29 install failed',e);}})();";view.evaluateJavascript(js,null);
    }
