...
public class MainActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setOnTouchListener((v,event)->{
            if(event.getAction()==MotionEvent.ACTION_DOWN && !v.hasFocus()) v.requestFocus();
            return false;
        });
        ...
        settings.setUserAgentString(settings.getUserAgentString()+" DMM-Android-Driver/3.06 SQLiteOffline/3 AtomicCompletion/1 LoginInputFix/1");
